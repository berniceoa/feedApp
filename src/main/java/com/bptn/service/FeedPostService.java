...
public class FeedPostService {
	...
	//this method getPostFromNewsAndSavePost
	//Step 1: build the third party API URL using the feedPostRequest object parameters entered by user
	//Step 2: print logger information once the URL is built
	//Step 3: create a eedResult by calling the getFeedFromNewsApI which gets the first post description
	//Step 4: Store the feed result into my Post table in my Post Column specifically
